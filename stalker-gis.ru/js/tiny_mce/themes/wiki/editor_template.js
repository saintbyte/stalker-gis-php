...
(function(tinymce) {
        ...
        tinymce.ThemeManager.requireLangPack('wiki');

        tinymce.create('tinymce.themes.wikiTheme', {
                ...
                init : function(ed, url) {
                        ...
                        t.settings = s = extend({
                                ...
                                theme_advanced_buttons2 : "bullist,numlist,|,outdent,indent,|,undo,redo,|,link,unlink,anchor,image,cleanup,help,code,charmap",
                        ...
                        if (tinymce.is(s.theme_wiki_font_sizes, 'string')) {
...
*/
        ...
        tinymce.ThemeManager.add('wiki', tinymce.themes.wikiTheme);
}(tinymce));
